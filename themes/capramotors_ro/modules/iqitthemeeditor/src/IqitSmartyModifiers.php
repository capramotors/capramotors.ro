...
class IqitSmartyModifiers
{
    ...
    {
        $to_convert = [
            'l' => ['dat' => 'N', 'str' => ['Poniedziałek', 'Wtorek', 'Środa', 'Czwartek', 'Piątek', 'Sobota', 'Niedziela']],
            'F' => ['dat' => 'n', 'str' => ['styczeń', 'luty', 'marzec', 'kwiecień', 'maj', 'czerwiec', 'lipiec', 'sierpień', 'wrzesień', 'październik', 'listopad', 'grudzień']],
            'f' => ['dat' => 'n', 'str' => ['stycznia', 'lutego', 'marca', 'kwietnia', 'maja', 'czerwca', 'lipca', 'sierpnia', 'września', 'października', 'listopada', 'grudnia']],
        ];
    ...
    public static function smarty_modifier_iqit_mb_substr($string, $start, $length = null, $encoding = 'UTF-8')
    {
        return $length !== null
